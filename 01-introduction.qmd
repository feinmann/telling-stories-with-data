...
I have to admit that I am better working in a well defined structure using script files, like developing `R` packages, for instance. Or the cookiecutter data-science template folder structure. That is because in a notebook I cannot really stick to order and also forget which cells were already executed. So, notebooks for me are too much freedom, I guess. But it took some years to figure that out. Nonetheless I think notebooks are pretty amazing for quick prototyping and then transferring the functions to script files. And there is an add-in for that.

In this project I really want to document my findings from the above mentioned book `Telling Stories with Data`, as it provides some exercises to internalize the advocated workflow, 1. plan, 2. simulate, 3. acquire, 4. explore and 5. communicate. I can really relate to that, as I am always forgetting to plan an analysis and instead start right into coding. Mostly I am already provided the data, so why stick to boring planning (my devil coder-I says). I think, being effective is really a result of practice. So, planning is the right thing to do, so practice planning in every project you take. That's it. Easy. I started reading the book by @drucker1985-sx.
